...
public class ClientRegistrar {
    ...
    public static void registerEntityRenders(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.HUSK_RABBIT.get(), HuskRabbitRenderer::new);
    ...
    public static void registerLayerDefinition(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModModelLayers.HYPER_RABBIT_BABY, () -> HyperRabbitModel.createBodyLayer().apply(HyperRabbitModel.BABY_TRANSFORMER));
        event.registerLayerDefinition(ModModelLayers.JUMBO_RABBIT, AdultJumboRabbitModel::createBodyLayer);
        event.registerLayerDefinition(ModModelLayers.JUMBO_RABBIT_BABY, BabyJumboRabbitModel::createBodyLayer);
        ...
        event.registerLayerDefinition(ModModelLayers.MUDDY_PIG_BABY, () -> BabyPigModel.createBodyLayer(CubeDeformation.NONE));
    ...
    @SubscribeEvent
    public static void registerKeyFrame(RegisterBagusKeyframeEvents event) {
        if (event.getModel() instanceof PigModel) {
            event.addAnimationKeyframe(SHAKE_ANIMATION, ShakeAnimations.shake.bake(event.getModel().root()));
        }
    }
}