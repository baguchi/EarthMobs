...
public class AdultJumboRabbitModel extends RabbitModel {
	...
	public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(1, 23).addBox(-2.5F, -5.0F, -5.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -13.0F, 0.3927F, 0.0F, 0.0F));
