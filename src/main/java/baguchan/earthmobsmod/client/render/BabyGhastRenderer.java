...
public class BabyGhastRenderer<T extends BabyGhast> extends MobRenderer<T, BabyGhastModel<T>> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(EarthMobsMod.MODID, "textures/entity/baby_ghast/baby_ghast.png");
	private static final ResourceLocation TEXTURE_SHOOT = ResourceLocation.fromNamespaceAndPath(EarthMobsMod.MODID, "textures/entity/baby_ghast/baby_ghast_shoot.png");
