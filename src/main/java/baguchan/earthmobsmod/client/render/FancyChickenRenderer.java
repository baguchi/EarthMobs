...
public class FancyChickenRenderer<T extends FancyChicken> extends AbstractChickenRender<T, ChickenRenderState, FancyChickenModel<ChickenRenderState>> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(EarthMobsMod.MODID, "textures/entity/fancy_chicken.png");
    ...
    @Override
    public Identifier getTextureLocation(ChickenRenderState p_110775_1_) {
		return TEXTURE;
	}
}