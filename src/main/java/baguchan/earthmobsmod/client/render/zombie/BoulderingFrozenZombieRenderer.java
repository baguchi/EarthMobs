...
import baguchan.earthmobsmod.entity.BoulderingFrozenZombie;
...
public class BoulderingFrozenZombieRenderer<T extends BoulderingFrozenZombie> extends AgeableMobRenderer<T, BoulderingZombieRenderState, BoulderingZombieModel<BoulderingZombieRenderState>> {
    private static final Identifier LOCATION = Identifier.fromNamespaceAndPath(EarthMobsMod.MODID, "textures/entity/bouldering_zombie/frozen_bouldering_zombie.png");

    public BoulderingFrozenZombieRenderer(EntityRendererProvider.Context p_173964_) {
