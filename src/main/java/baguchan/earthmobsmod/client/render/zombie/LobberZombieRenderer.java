...
public class LobberZombieRenderer<T extends LobberZombie> extends AgeableMobRenderer<T, LobberZombieRenderState, LobberZombieModel<LobberZombieRenderState>> {
    private static final Identifier LOCATION = Identifier.fromNamespaceAndPath(EarthMobsMod.MODID, "textures/entity/lobber_zombie/lobber_zombie.png");
    ...
    public Identifier getTextureLocation(LobberZombieRenderState p_114115_) {
		return LOCATION;
	}
}
