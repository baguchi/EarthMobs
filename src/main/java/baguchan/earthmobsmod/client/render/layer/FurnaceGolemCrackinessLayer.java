...
public class FurnaceGolemCrackinessLayer<T extends FurnaceGolem> extends RenderLayer<T, FurnaceGolemModel<T>> {
    private static final Map<FurnaceGolem.Crackiness, ResourceLocation> resourceLocations = ImmutableMap.of(FurnaceGolem.Crackiness.LOW, ResourceLocation.withDefaultNamespace("textures/entity/iron_golem/iron_golem_crackiness_low.png"), FurnaceGolem.Crackiness.MEDIUM, ResourceLocation.withDefaultNamespace("textures/entity/iron_golem/iron_golem_crackiness_medium.png"), FurnaceGolem.Crackiness.HIGH, ResourceLocation.withDefaultNamespace("textures/entity/iron_golem/iron_golem_crackiness_high.png"));
    ...
    public void render(PoseStack p_117148_, MultiBufferSource p_117149_, int p_117150_, T p_117151_, float p_117152_, float p_117153_, float p_117154_, float p_117155_, float p_117156_, float p_117157_) {
        if (!p_117151_.isInvisible()) {
            ...
            if (irongolem$crackiness != FurnaceGolem.Crackiness.NONE) {
                ...
                renderColoredCutoutModel(this.getParentModel(), resourcelocation, p_117148_, p_117149_, p_117150_, p_117151_, FastColor.ARGB32.colorFromFloat(1.0F, 1.0F, 1.0F, 1.0F));
            }
        }
    }
}