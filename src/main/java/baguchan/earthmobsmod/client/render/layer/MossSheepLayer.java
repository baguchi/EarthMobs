...
public class MossSheepLayer<T extends Sheep> extends RenderLayer<T, EntityModel<T>> {
    private static final ResourceLocation SHEEP_FUR_LOCATION = new ResourceLocation(EarthMobsMod.MODID, "textures/entity/sheep_moss.png");
        ...
        if (!p_117424_.isSheared() && p_117424_ instanceof IMoss moss) {
            if (moss.isMoss()) {
                if (p_117424_.isInvisible()) {
                    ...
                    coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, SHEEP_FUR_LOCATION, p_117421_, p_117422_, p_117423_, p_117424_, p_117425_, p_117426_, p_117428_, p_117429_, p_117430_, p_117427_, 1, 1, 1);
                }
            }
        }
    }
