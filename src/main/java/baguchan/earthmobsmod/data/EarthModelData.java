...
public class EarthModelData extends ModelProvider {
    private final PackOutput.PathProvider blockStatePathProvider;
    private final PackOutput.PathProvider itemInfoPathProvider;
    private final PackOutput.PathProvider modelPathProvider;

    public EarthModelData(PackOutput packOutput) {
        super(packOutput, EarthMobsMod.MODID);
    ...
    public CompletableFuture<?> run(CachedOutput output) {
        ...
        this.registerModels(new EarthBlockModels(blockModelOutput, itemModelOutput, modelOutput), new EarthItemModels(itemModelOutput, modelOutput));
