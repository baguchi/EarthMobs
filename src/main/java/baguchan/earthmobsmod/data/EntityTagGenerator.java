...
public class EntityTagGenerator extends EntityTypeTagsProvider {
	...
	protected void addTags(HolderLookup.Provider p_256380_) {
        ...
        this.tag(EntityTypeTags.FREEZE_IMMUNE_ENTITY_TYPES).add(ModEntities.MELON_GOLEM.get(), ModEntities.MAGMA_COW.get(), ModEntities.UMBRA_COW.get(), ModEntities.WOOLY_COW.get());
