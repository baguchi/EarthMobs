...
public class ModRecipes {
	...
	public static final Supplier<RecipeSerializer<? extends TippedArrowWithBoneRecipe>> RECIPE_TIPPED_ARROW_WITH_BONE = RECIPE_SERIALIZERS.register("tipped_arrow_with_bone", () -> TippedArrowWithBoneRecipe.SERIALIZER);
}